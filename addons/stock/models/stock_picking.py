...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Bookm will automatically pre-fill the detailed "
    ...
    auto_show_reception_report = fields.Boolean(
        ...
        help="If this checkbox is ticked, Bookm will automatically show the reception report (if there are moves to allocate to) when validating.")
