...
QUnit.module("ActionManager", (hooks) => {
  ...
  QUnit.test(
    "can execute act_window actions from db ID",
  ...
  QUnit.test("sidebar is present in list view", async function (assert) {
    ...
    await testUtils.dom.clickFirst(
      $(webClient.el).find("input.custom-control-input")
    )
    assert.isVisible(
      $(webClient.el).find(
        '.o_cp_action_menus button.dropdown-toggle:contains("Print")'
      )[0]
    )
    assert.isVisible(
      $(webClient.el).find(
  ...
  QUnit.test("can switch between views", async function (assert) {
    ...
    await testUtils.dom.click(
      webClient.el.querySelector(".o_list_view .o_data_row")
    )
    await legacyExtraNextTick()
    assert.containsNone(
      webClient,
    ...
    await testUtils.dom.click(
      webClient.el.querySelector(".o_control_panel .breadcrumb a")
    )
    await legacyExtraNextTick()
    assert.containsOnce(
      webClient,
  ...
  QUnit.test(
    ...
    `
      ...
      // quick create record
      await testUtils.dom.click(
        webClient.el.querySelector(".o-kanban-button-new")
      )
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      // Sort records
      await testUtils.dom.click(
        $(webClient.el).find(".o_list_view th.o_column_sortable")
      )
      await legacyExtraNextTick()
  ...
  QUnit.test(
    "breadcrumbs are updated when switching between views",
    async function (assert) {
      assert.expect(15)
      ...
      // open a record in form view
      await testUtils.dom.click(
        webClient.el.querySelector(".o_kanban_view .o_kanban_record")
      )
      await legacyExtraNextTick()
      assert.containsN(
        webClient.el,
  ...
  QUnit.test(
    "switch buttons are updated when switching between views",
    async function (assert) {
      assert.expect(13)
      const webClient = await createWebClient({ serverData })
      await doAction(webClient, 3)
      ...
      // go back to list view using the breadcrumbs
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .breadcrumb a")
      )
      await legacyExtraNextTick()
      assert.containsN(
        webClient.el,
  ...
  QUnit.test(
    "pager is updated when switching between views",
    async function (assert) {
      assert.expect(10)
      const webClient = await createWebClient({ serverData })
  ...
  QUnit.test(
    "domain is kept when switching between views",
    async function (assert) {
      assert.expect(5)
      ...
      // remove the domain
      await testUtils.dom.click(
        webClient.el.querySelector(".o_searchview .o_facet_remove")
      )
      await legacyExtraNextTick()
  ...
  QUnit.test(
    "there is no flickering when switching between views",
    async function (assert) {
      assert.expect(20)
      let def
      const mockRPC = async (route, args) => {
      ...
      def = testUtils.makeTestPromise()
      await testUtils.dom.click(
        $(webClient.el).find(".o_list_view .o_data_row:first")
      )
      await legacyExtraNextTick()
      assert.containsOnce(
        webClient,
  ...
  QUnit.test(
    "breadcrumbs are updated when display_name changes",
    async function (assert) {
      assert.expect(4)
      const webClient = await createWebClient({ serverData })
      await doAction(webClient, 3)
      ...
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .o_form_button_edit")
      )
      await testUtils.fields.editInput(
        webClient.el.querySelector(".o_field_widget[name=display_name]"),
        "New name"
  ...
  QUnit.test(
    'reverse breadcrumb works on accesskey "b"',
    async function (assert) {
      assert.expect(4)
      const webClient = await createWebClient({ serverData })
      await doAction(webClient, 3)
  ...
  QUnit.test(
    "reload previous controller when discarding a new record",
    async function (assert) {
      assert.expect(9)
      const mockRPC = async (route, args) => {
        assert.step((args && args.method) || route)
      ...
      // create a new record
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .o_list_button_add")
      )
      await legacyExtraNextTick()
      assert.containsOnce(
        webClient.el,
      ...
      // discard
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .o_form_button_cancel")
      )
      await legacyExtraNextTick()
      assert.containsOnce(
        webClient.el,
  ...
  QUnit.test(
    "requests for execute_action of type object are handled",
    async function (assert) {
      assert.expect(11)
  ...
  QUnit.test(
    ...
    <button string="Cancel" class="cancel-btn" special="cancel"/>
      ...
      await testUtils.dom.click(
        webClient.el.querySelector('.o_form_view button[name="4"]')
      )
      await legacyExtraNextTick()
      assert.ok(
        webClient.el.querySelector(".o_cp_buttons .o_form_button_edit")
          .disabled,
      ...
      await testUtils.dom.click(
        webClient.el.querySelector(".modal .cancel-btn")
      )
      await legacyExtraNextTick()
      assert.notOk(
        webClient.el.querySelector(".o_cp_buttons .o_form_button_edit")
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      // click on 'Execute action', to execute action 4 in a dialog
      testUtils.dom.click(
        webClient.el.querySelector('.o_form_view button[name="object"]')
      )
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      assert.containsOnce(webClient.el, ".modal .o_form_view")
      testUtils.dom.click(
        webClient.el.querySelector('.modal footer button[name="object"]')
      )
      assert.containsOnce(webClient.el, ".modal .o_form_view")
  ...
  QUnit.test(
    "requests for execute_action of type action are handled",
    async function (assert) {
      assert.expect(12)
      const mockRPC = async (route, args) => {
        assert.step((args && args.method) || route)
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      assert.strictEqual(
        $(webClient.el)
          .find(".o_form_view button:contains(Call method)")
          .attr("disabled"),
        "disabled",
        "buttons should be disabled"
      )
  ...
  QUnit.test(
    "can open different records from a multi record view",
    async function (assert) {
      assert.expect(12)
      const mockRPC = async (route, args) => {
        assert.step((args && args.method) || route)
      ...
      await testUtils.dom.click(
        $(webClient.el).find(".o_list_view .o_data_row:nth(1)")
      )
      await legacyExtraNextTick()
      assert.strictEqual(
        $(webClient.el).find(".o_control_panel .breadcrumb-item:last").text(),
  ...
  QUnit.test(
    "restore previous view state when switching back",
    async function (assert) {
      assert.expect(5)
      ...
      // display line chart
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel  .fa-area-chart")
      )
      await legacyExtraNextTick()
      assert.hasClass(
        $(webClient.el).find(".o_control_panel  .fa-area-chart")[0],
  ...
  QUnit.test(
    "view switcher is properly highlighted in graph view",
    async function (assert) {
      assert.expect(4)
  ...
  QUnit.test('save when leaving a "dirty" view', async function (assert) {
    ...
    await testUtils.fields.editInput(
      $(webClient.el).find('input[name="foo"]'),
      "pinkypie"
    )
    ...
    assert.containsNone(
      document.body,
      ".modal",
      "should not display a modal dialog"
    )
    assert.containsNone(
      webClient,
      ".o_form_view",
  ...
  QUnit.test(
    "limit set in action is passed to each created controller",
    async function (assert) {
      assert.expect(2)
  ...
  QUnit.test(
    "go back to a previous action using the breadcrumbs",
    async function (assert) {
      assert.expect(10)
      const webClient = await createWebClient({ serverData })
      await doAction(webClient, 3)
      ...
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .breadcrumb a:nth(1)")
      )
      await legacyExtraNextTick()
      assert.containsN(
        webClient.el,
      ...
      // go back using the breadcrumbs
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .breadcrumb a:first")
      )
      await legacyExtraNextTick()
      assert.containsN(
        webClient.el,
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      await legacyExtraNextTick()
      assert.hasClass(
        $(webClient.el).find(".o_form_view")[0],
        "o_form_editable"
      )
      // do some other action
      await doAction(webClient, 4)
      // go back to form view
      await testUtils.dom.clickLast(
        $(webClient.el).find(".o_control_panel .breadcrumb a")
      )
      await legacyExtraNextTick()
      assert.hasClass(
  ...
  QUnit.test(
    "honor group_by specified in actions context",
    async function (assert) {
      assert.expect(5)
      ...
      await testUtils.dom.click(
        $(webClient.el).find(
          ".o_control_panel .o_cp_bottom_right button:contains(Group By)"
        )
      )
      await testUtils.dom.click(
        $(webClient.el).find(
          ".o_control_panel .o_group_by_menu .o_menu_item:first"
        )
      )
      await legacyExtraNextTick()
      assert.containsN(
  ...
  QUnit.test(
    "flags field of ir.actions.act_window is used",
    async function (assert) {
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      await legacyExtraNextTick()
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .breadcrumb a:eq(0)")
      )
      await legacyExtraNextTick()
      assert.strictEqual(
        $(webClient.el).find(".o_list_view tr.o_data_row .o_data_cell").text(),
  ...
  QUnit.test(
    "current act_window action is stored in session_storage",
    async function (assert) {
      assert.expect(1)
  ...
  QUnit.test(
    "destroy action with lazy loaded controller",
    async function (assert) {
      assert.expect(6)
      const webClient = await createWebClient({ serverData })
  ...
  QUnit.test(
    "execute action from dirty, new record, and come back",
    async function (assert) {
      assert.expect(18)
      ...
      await testUtils.dom.click(
        $(webClient.el).find(".o_form_uri:contains(First record)")
      )
      await legacyExtraNextTick()
  ...
  QUnit.test(
    "execute a contextual action from a form view",
    async function (assert) {
      assert.expect(4)
      ...
      await testUtils.controlPanel.toggleMenuItem(
        webClient.el,
        "Favorite Ponies"
      )
      await legacyExtraNextTick()
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      assert.containsOnce(webClient.el, ".o_form_view")
      assert.hasClass(
        webClient.el.querySelector(".o_form_view"),
        "o_form_readonly"
      )
      assert.strictEqual(
      ...
      await testUtils.dom.click(
        $(webClient.el).find(".o_form_uri:contains(Third record)")
      )
      await legacyExtraNextTick()
      assert.strictEqual(
        webClient.el.querySelector(".o_control_panel .breadcrumb").textContent,
      ...
      assert.strictEqual(
        webClient.el.querySelector(".o_control_panel .breadcrumb-item")
          .textContent,
        "Second record"
      )
    }
  ...
  QUnit.test(
    "open a record, come back, and create a new record",
    async function (assert) {
      assert.expect(7)
      const webClient = await createWebClient({ serverData })
      // execute an action and open a record
      ...
      // go back using the breadcrumbs
      await testUtils.dom.click(
        $(webClient.el).find(".o_control_panel .breadcrumb-item a")
      )
      await legacyExtraNextTick()
      assert.containsOnce(webClient.el, ".o_list_view")
      // create a new record
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      await testUtils.dom.click(
        $(webClient.el).find(".o_statusbar_buttons button[name=4]")
      )
      await legacyExtraNextTick()
      assert.containsOnce(webClient.el, ".o_kanban_view")
      // go back using the breadcrumbs
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      const TestCustoFormController =
        FormView.prototype.config.Controller.extend({
          async saveRecord() {
      ...
      await testUtils.dom.click(
        webClient.el.querySelector(
          ".o_dialog .modal-footer button[special=save]"
        )
      )
  ...
  QUnit.test(
    "search view should keep focus during do_search",
    async function (assert) {
      assert.expect(5)
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      await testUtils.dom.click(
        webClient.el.querySelector(".o_list_button_add")
      )
      assert.containsOnce(
        document.body,
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      assert.containsOnce(
        webClient,
        ".o_dialog .o_act_window .o_view_controller"
      )
    }
  )
  ...
  QUnit.test(
    "do not restore after action button clicked",
    async function (assert) {
      assert.expect(5)
      const mockRPC = async (route, args) => {
        if (
          route === "/web/dataset/call_button" &&
          args.method === "do_something"
        ) {
          return true
        }
      }
      ...
      await legacyExtraNextTick()
      assert.isVisible(
        webClient.el.querySelector(".o_form_buttons_view .o_form_button_edit")
      )
      await click(
        webClient.el.querySelector(".o_form_buttons_view .o_form_button_edit")
      )
      await legacyExtraNextTick()
      assert.isVisible(
        webClient.el.querySelector(".o_form_buttons_edit .o_form_button_save")
      )
      assert.isVisible(
        webClient.el.querySelector(
          ".o_statusbar_buttons button[name=do_something]"
        )
      )
      await click(
        webClient.el.querySelector(
  ...
  QUnit.test(
    "debugManager is active for (legacy) views",
    async function (assert) {
      assert.expect(2)
      ...
      await click(
        webClient.el.querySelector(".o_debug_manager .dropdown-toggle")
      )
      assert.containsOnce(
        webClient.el,
        ".o_debug_manager .dropdown-item:contains('Edit View: Kanban')"
  ...
  QUnit.test(
    "reload a view via the view switcher keep state",
    async function (assert) {
      assert.expect(6)
  ...
  QUnit.test(
    "doAction supports being passed globalState prop",
    async function (assert) {
      assert.expect(1)
  ...
  QUnit.test("pushState also changes the title of the tab", async (assert) => {
    ...
    assert.strictEqual(
      titleService.current,
      '{"zopenerp":"Bookm","action":"Partners"}'
    )
    await click(webClient.el.querySelector(".o_data_row"))
    await legacyExtraNextTick()
    assert.strictEqual(
      titleService.current,
      '{"zopenerp":"Bookm","action":"First record"}'
    )
    await click(webClient.el.querySelector(".o_pager_next"))
    assert.strictEqual(
      titleService.current,
      '{"zopenerp":"Bookm","action":"Second record"}'
    )
  })

  QUnit.test(
    "action part of title is updated when an action is mounted",
    async (assert) => {
