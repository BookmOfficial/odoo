...
QUnit.module("ActionManager", (hooks) => {
  ...
  QUnit.test(
    "can display client actions as main, then in Dialog",
  ...
  QUnit.test(
    "can execute client actions from tag name (legacy)",
    async function (assert) {
  ...
  QUnit.test(
    "can execute client actions from tag name",
    async function (assert) {
      assert.expect(4)
  ...
  QUnit.test(
    "async client action (function) returning another action",
    async function (assert) {
      assert.expect(1)
  ...
  QUnit.test(
    "client action with control panel (legacy)",
    async function (assert) {
      assert.expect(4)
  ...
  QUnit.test(
    "state is pushed for client action (legacy)",
    async function (assert) {
      assert.expect(6)
      const ClientAction = AbstractAction.extend({
        getTitle: function () {
      ...
      assert.strictEqual(currentTitle, '{"zopenerp":"Bookm"}')
  ...
  QUnit.test(
    "action can use a custom control panel (legacy)",
    async function (assert) {
      assert.expect(1)
  ...
  QUnit.test(
    "breadcrumb is updated on title change (legacy)",
    async function (assert) {
      assert.expect(2)
      const ClientAction = AbstractAction.extend({
        hasControlPanel: true,
  ...
  QUnit.test(
    "client actions can have breadcrumbs (legacy)",
    async function (assert) {
      assert.expect(4)
      const ClientAction = AbstractAction.extend({
        hasControlPanel: true,
  ...
  QUnit.test(
    "ClientAction receives breadcrumbs and exports title (wowl)",
    async (assert) => {
      assert.expect(4)
      class ClientAction extends Component {
        setup() {
  ...
  QUnit.test(
    "ClientAction receives arbitrary props from doAction (wowl)",
    async (assert) => {
      assert.expect(1)
      class ClientAction extends Component {
        setup() {
  ...
  QUnit.test(
    "ClientAction receives arbitrary props from doAction (legacy)",
    async (assert) => {
      assert.expect(1)
      const ClientAction = AbstractAction.extend({
  ...
  QUnit.test(
    "test display_notification client action",
    async function (assert) {
      assert.expect(6)
      const webClient = await createWebClient({ serverData })
      ...
      const notificationElement =
        document.body.querySelector(notificationSelector)
      assert.strictEqual(
      ...
      assert.strictEqual(
        notificationElement.querySelector(".o_notification_content")
          .textContent,
        "message",
  ...
  QUnit.test(
    "test display_notification client action with links",
    async function (assert) {
      assert.expect(8)
      const webClient = await createWebClient({ serverData })
      await doAction(webClient, 1)
  ...
  QUnit.test(
    "test next action on display_notification client action",
    async function (assert) {
      const webClient = await createWebClient({ serverData })
      const options = {
        onClose: function () {
