  ...
  tour.register(
    "event_tour",
    {
      ...
      rainbowManMessage: _t(
        "Great! Now all you have to do is wait for your attendees to show up!"
      ),
      sequence: 210,
    },
    [
      tour.stepUtils.showAppsMenuItem(),
      {
        ...
        content: Markup(
          _t(
            "Ready to <b>organize events</b> in a few minutes? Let's get started!"
          )
        ),
        position: "bottom",
        edition: "enterprise",
      ...
      },
      {
        ...
        content: Markup(
          _t("This is the <b>name</b> your guests will see when registering.")
        ),
        run: "text Experience 2020",
      },
      {
        trigger: '.o_event_form_view input[name="date_end"]',
        content: Markup(
          _t(
            "When will your event take place? <b>Select</b> the start and end dates <b>and click Apply</b>."
          )
        ),
        run: function () {
      ...
      {
        trigger:
          '.o_event_form_view div[name="event_ticket_ids"] .o_field_x2many_list_row_add a',
        content: Markup(
          _t(
            "Ticket types allow you to distinguish your attendees. Let's <b>create</b> a new one."
          )
        ),
      },
      ...new EventAdditionalTourSteps()._get_website_event_steps(),
      {
        ...
        content: _t(
          "Now that your event is ready, click here to move it to another stage."
        ),
        position: "bottom",
      },
      {
        ...
        content: Markup(
          _t("Use the <b>breadcrumbs</b> to go back to your kanban overview.")
        ),
        position: "bottom",
        run: "click",
      },
