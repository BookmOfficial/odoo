...
const descriptionActivities = escFormat(
  _lt("%s Use the %s icon to organize your daily activities."),
  "<br/>",
  clock
)
const description = escFormat(
  _lt(
    "Prioritize Tasks by using the %s icon." +
  ...
  examples: [
    ...
    },
    {
      ...
      columns: [
        _lt("Backlog"),
        _lt("Sprint Backlog"),
        _lt("Sprint in Progress"),
        _lt("Sprint Complete"),
        _lt("Old Completed Sprint"),
      ],
      description: escFormat(
        _lt("Use %s and %s bullets to indicate the status of a task. %s"),
        greenBullet,
        redBullet,
        descriptionActivities
      ),
    ...
    },
    {
      ...
      description: escFormat(
        _lt(
          "Everyone can propose ideas, and the Editor marks the best ones " +
            "as %s. Attach all documents or links to the task directly, to have all research information centralized. %s"
        ),
        greenBullet,
        descriptionActivities
      ),
    ...
    },
    {
      ...
      description: escFormat(
        _lt(
          "Customers propose feedbacks by email; Bookm creates tasks " +
      ...
      description: escFormat(
        _lt(
          "Fill your Inbox easily with the email gateway. Periodically review your " +
            ...
            "%s column to move important tasks %s. Every Monday, you review the %s column. %s"
        ),
        _lt('"This Week"'),
        _lt('"Today"'),
        _lt('"This Month"'),
    ...
    },
    {
      ...
      columns: [
        _lt("New Projects"),
        _lt("Resources Allocation"),
        _lt("In Progress"),
        _lt("Done"),
      ],
      description: escFormat(
        _lt(
          "Manage the lifecycle of your project using the kanban view. Add newly acquired projects, assign them and use the %s and %s to define if the project is ready for the next step. %s"
        ),
        greenBullet,
        redBullet,
        descriptionActivities
    ...
    },
    {
      ...
      description: escFormat(
        _lt(
          "Handle your idea gathering within Tasks of your new Project and discuss them in the chatter of the tasks. Use the %s and %s to signalize what is the current status of your Idea. %s"
        ),
        greenBullet,
        redBullet,
        descriptionActivities
    ...
    },
    {
      ...
      description: escFormat(
        _lt(
          "Communicate with customers on the task using the email gateway. " +
            "Attach logo designs to the task, so that information flows from designers to the workers " +
            "who print the t-shirt. Organize priorities amongst orders using the %s icon. %s"
        ),
        star,
        descriptionActivities
      ),
