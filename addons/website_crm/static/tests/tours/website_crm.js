odoo.define("website_crm.tour", function (require) {
  ...
  tour.register(
    ...
    [
      ...
      },
      {
        ...
        trigger:
          "we-select:has(we-button:contains('Create an Opportunity')) we-toggler",
      ...
      {
        content:
          "Ensure form model has changed and page reload is done after save",
  ...
  tour.register(
    "website_crm_catch_logged_partner_info_tour",
    {
      test: true,
      url: "/contactus",
    },
