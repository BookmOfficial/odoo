    ...
    tour.register(
      ...
      [
        ...
        },
        {
          ...
          trigger:
            "#oe_snippets .oe_snippet:has(.s_website_form) .oe_snippet_thumbnail",
        ...
        ...addExistingField(
          ...
          false,
          { visibility: CONDITIONALVISIBILITY, condition: "Bookm" }
        ),

        ...addExistingField("date", "text", "Test Date", true),

        ...addExistingField("record_name", "text", "Awesome Label", false, {
          visibility: HIDDEN,
        }),
        ...
        },
        {
          content: "Check the resulting field",
          trigger:
            ".s_website_form_field.s_website_form_custom.s_website_form_required" +
        ...
        },
        {
          content: "Check the resulting field",
          trigger:
            ".s_website_form_field.s_website_form_custom:not(.s_website_form_required)" +
        ...
        },
        {
          ...
          trigger:
            ".s_website_form_send.btn.btn-sm.btn-secondary.rounded-circle",
          run: () => null,
        },
        // Save the page
        {
        ...
        },
        {
          ...
          run: function () {
            ...
            if (style.display !== "none") {
              console.error(
                "error This field should be invisible when the name is not Bookm"
              )
            }
          },
        },
